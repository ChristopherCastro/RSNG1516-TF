...
if exist('runSetsResults','var')
    ...
    %         fprintf('    · Event Generator (Service Time): %d\n', runSetConf.tmService);
            ...
            plot(bottomRight,runSetStats{1}.time, runSetStats{1}.roMean,...
                runSetStats{2}.time, runSetStats{2}.roMean,...
                runSetStats{3}.time, runSetStats{3}.roMean,...
                runSetStats{4}.time, runSetStats{4}.roMean,...
                runSetStats{5}.time, runSetStats{5}.roMean,...
                runSetStats{6}.time, runSetStats{6}.roMean,...
                runSetStats{7}.time, runSetStats{7}.roMean,...
                runSetStats{8}.time, runSetStats{8}.roMean,...
                runSetStats{9}.time, runSetStats{9}.roMean,...
                runSetStats{10}.time, runSetStats{10}.roMean);
