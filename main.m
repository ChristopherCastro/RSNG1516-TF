...
%     struct('eventsGenerator', 1, 'lambda', 1, 'tmService', 2, 'nThreads', 5, 'waitQueueLen', 0, 'machinesNumber', 3, 'loadBalancer', 1, 'numClients', 5000), ...
    struct('eventsGenerator', 1, 'lambda', 1, 'tmService', 2, 'nThreads', 5, 'waitQueueLen', 10, 'machinesNumber', 3, 'loadBalancer', 2, 'numClients', 100),...
    struct('eventsGenerator', 1, 'lambda', 1, 'tmService', 3, 'nThreads', 5, 'waitQueueLen', 10, 'machinesNumber', 3, 'loadBalancer', 2, 'numClients', 100)
};
